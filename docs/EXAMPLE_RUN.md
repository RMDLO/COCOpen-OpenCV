...
> Note: For this example demo we will be using foreground (wire & device) and background images from the [UIUC wires dataset](https://uofi.box.com/s/b8llku4yrvq44ijedw0lol1oz5sx7rja). This dataset has been provided to you to test the API on by default 😊.
